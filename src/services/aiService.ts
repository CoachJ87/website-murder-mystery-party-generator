...
## PREMISE
The glittering world of Hollywood is rocked when renowned director Marcus Reynolds is found dead at his own film premiere.
...
1. **Victoria/Victor Harlow** - Marcus's ex-spouse and producer
2. **Ethan/Elena Stone** - The film's ambitious lead actor
3. **James/Jamie Wong** - A rival director
4. **Olivia/Oliver Greene** - The studio executive

## STEPS TO SOLVE
1. Examine the crime scene
2. Interview suspects
3. Review security footage
4. Analyze physical evidence

## TO-DO LIST
- [ ] Set up the crime scene
- [ ] Prepare character dossiers
- [x] Review security protocols
- [x] Brief the actors

Would this murder mystery concept work for your event?`;
  }
};
