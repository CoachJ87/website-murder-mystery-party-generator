...
const MysteryPurchase = () => {
  ...
  const handlePurchase = async () => {
    ...
    try {
      ...
      const stripeUrl = `https://buy.stripe.com/dRmdRa2uC2ZS3DW1gd2Nq02?prefilled_email=${encodeURIComponent(user?.email || '')}&success_url=${encodeURIComponent(successUrl)}&cancel_url=${encodeURIComponent(cancelUrl)}`;
      // Redirect to Stripe
