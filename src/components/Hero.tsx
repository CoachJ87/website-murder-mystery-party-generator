...
const MYSTERY_THEMES = [
  ...
  { name: "Bakery Competition", prompt: "Design a whodunit centered around a small-town bakery competition." },
  { name: "Mountain Ski Resort", prompt: "Develop a murder mystery at an isolated mountain ski resort during a blizzard." },
  { name: "Luxury Train Journey", prompt: "Craft a mystery set on a luxury train journey." },
  { name: "Historic University", prompt: "Build a murder case at a historic university." },
  ...
  { name: "Jungle Steampunk", prompt: "Develop a steampunk jungle adventure mystery." },
