          ...
          <>
            ...
            <section className="py-8 sm:py-12 px-2 sm:px-4 md:px-6 lg:px-8">
              <div className="w-full max-w-7xl mx-auto text-center">
                ...
                <a 
                  href="/support"
                  className="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-[#E6A73E] text-[#1D2B35] hover:bg-[#C26E3E] hover:text-white h-12 px-6 text-base no-underline"
                >
